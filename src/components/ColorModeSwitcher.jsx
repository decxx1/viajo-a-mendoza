	...
	return (
		<>
			<button
				...
				className="text-primary-700 hover:text-white hover:bg-primary-700 dark:hover:bg-gray-700 dark:text-gray-400 dark:hover:text-white focus:outline-none focus:ring-4 focus:ring-primary-600 dark:focus:ring-gray-700 rounded-md text-sm p-2.5"
			>
				{!iconDark && (
					<svg
						className="w-5 h-5"
